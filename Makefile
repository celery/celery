...
help:
	...
	@echo "  docker-build			- Build celery docker containers."
...
docker-unit-tests:
	@docker compose -f docker/docker-compose.yml run --rm -w /home/developer/celery celery312 tox -e 3.12-unit -- $(filter-out $@,$(MAKECMDGOALS))
...
docker-integration-tests:
	@docker compose -f docker/docker-compose.yml run --rm -w /home/developer/celery celery312 tox -e 3.12-integration-docker -- --maxfail=1000

.PHONY: docker-bash
docker-bash:
	@docker compose -f docker/docker-compose.yml run --rm -w /home/developer/celery celery312 bash
