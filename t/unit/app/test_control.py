...
class test_Control:
    ...
    def assert_control_called_with_args(
        self, name, destination=None, _options=None, **args
    ):
        self.app.control.broadcast.assert_called_with(
    ...
    def test_ping(self):
        ...
        self.assert_control_called_with_args(
            "ping", destination=None, _options={"timeout": 1.0, "reply": True}
        )
    ...
    def test_pool_grow__with_options(self):
        ...
        self.assert_control_called_with_args(
            "pool_grow", n=2, destination="a@q.com", _options={"limit": 39}
        )
    ...
    def test_pool_shrink__with_options(self):
        ...
        self.assert_control_called_with_args(
            "pool_shrink", n=2, destination="a@q.com", _options={"limit": 39}
        )
