...
class test_AzureBlockBlobBackend:
    ...
    def test_configure_client(self, mock_blob_service_factory):
        ...
        (
            mock_blob_service_factory.from_connection_string.assert_called_once_with(
                connection_string,
    ...
    def test_get_missing(self, mock_client):
        mock_client.get_blob_client.return_value.download_blob.return_value.readall.side_effect = (
            azureblockblob.ResourceNotFoundError
        )
    ...
    def test_set(self, mock_client, base_path):
        ...
        mock_client.get_blob_client.return_value.upload_blob.assert_called_once_with(
            "myvalue", overwrite=True
        )
